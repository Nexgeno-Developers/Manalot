                    ...
                    <div class="position-relative">
                        ...
                        <select class="form-select input_select" aria-label="Default select example"
                            ...
                            @foreach ($years_of_exp as $row)
                                <option value="{{ $row->id }}"
                                    @if ($user_detail->wrk_exp_years == $row->id) selected @endif>
        ...
        <form id="skills-info" action="{{ url(route('account.create', ['param' => 'skills-info'])) }}"
            ...
            <div class="col-md-6 mb-4">
                <div class="position-relative">
                    ...
                    <select class="form-select input_select" aria-label="Default select example" id="skills"
                        name="skill" required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    <div class="position-relative">
                        ...
                        <select class="form-select input_select" aria-label="Default select example" id="References*"
